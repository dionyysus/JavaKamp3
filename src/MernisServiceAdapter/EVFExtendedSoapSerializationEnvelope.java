...
public class EVFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EVFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EVFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EVFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EVFDateTimeConverter dateTimeConverter = new EVFStandardDateTimeConverter();

    public EVFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EVFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EVFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EVFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EVFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EVFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
