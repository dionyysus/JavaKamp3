...
public class EVFKPSPublicSoap
{
    ...
    public EVFKPSPublicSoap(){}

    public EVFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EVFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EVFExtendedSoapSerializationEnvelope envelope= new EVFExtendedSoapSerializationEnvelope(EVFExtendedSoapSerializationEnvelope.VER11);
